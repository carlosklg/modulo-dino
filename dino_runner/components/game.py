...
from dino_runner.components.dinousar import Dinosaur
...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_cout == 0:
            draw_message_component("APERTE QUALQUER TECLA PARA INICIAR", self.screen)
        else:
            draw_message_component("PRESSIONE QUALQUER TECLA PARA RENICIAR", self.screen, pos_x_center=half_screen_heigth + 140)
            draw_message_component(
